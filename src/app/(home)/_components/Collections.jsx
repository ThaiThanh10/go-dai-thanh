    ...
    <section className="py-24 px-6 md:px-12 bg-white">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto reveal-stagger">
        <div data-purpose="product-card">
          ...
          <h3 className="text-atcGold font-semibold uppercase tracking-widest text-lg mb-4">
            Sofa Sets
          </h3>
          <p className="text-xs text-atcMuted leading-relaxed mb-4 line-clamp-2">
            Outdoor wicker sofa sets lead 2025 trends with HDPE durability,
            UV/weather resistance &amp; refined style – unlike natural rattan...
          </p>
          <a
            className="text-[10px] uppercase tracking-widest border-l border-gray-300 pl-4 hover:text-atcGold transition-colors flex items-center gap-2"
            href="#"
          >
            View More <span>→</span>
          </a>
      ...
      <div className="flex justify-center gap-4 mt-12 reveal">
        <button className="p-4 rounded-full border border-gray-200">←</button>
        <button className="p-4 rounded-full border border-gray-200">→</button>
      </div>
    </section>
  )
